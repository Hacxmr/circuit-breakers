...
JSON_FORMAT_QUESTION_PROMPT = """You need to extract the research questions from the following response and format them as JSON. 

Response: '{resp}'

Please extract all questions and return them in this exact JSON format:
{{
    "questions": [
        {{
        ...
        {{
            "question": "Additional questions if any"
        }}
    ]
}}

Only include actual questions from the response. If no clear questions are found, include at least one relevant research question about the topic discussed."""
